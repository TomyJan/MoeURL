...
describe('moeurlThemeCss', () => {
  it('defines global application surfaces and radius tokens', () => {
    ...
    expect(moeurlThemeCss).toContain('0 0 0 4px color-mix(in srgb, rgb(var(--v-theme-primary)) 18%, transparent)')
    expect(moeurlThemeCss).toContain('0 16px 34px color-mix(in srgb, rgb(var(--v-theme-primary)) 12%, transparent)')
