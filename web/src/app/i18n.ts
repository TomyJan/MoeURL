...
export const messages = {
  'zh-CN': {
    ...
    shortLinkCreate: {
      ...
      passwordInvalid: '密码需包含 8 至 128 个字符',
    },
    shortLinkSettings: {
      title: '访问配置',
      targetUrl: '目标链接',
  ...
  en: {
    ...
    shortLinkCreate: {
      ...
      passwordInvalid: 'Password must contain 8 to 128 characters',
    },
    shortLinkSettings: {
    ...
    redirect: {
      ...
      notIntermediate: 'This short link no longer uses an intermediate page.',
