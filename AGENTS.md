...
3. `docs/product/scope-v0.0.2.md`
...
3. `docs/implementation/v0.0.2-plan.md`
4. `docs/implementation/v0.0.2-tasks.md`
5. `docs/implementation/v0.0.2-acceptance.md`
...
- v0.0.2 只实现 `docs/product/scope-v0.0.2.md` 中列入必须实现的内容。
