...
4. [v0.0.1 工程实施合同](implementation/v0.0.1-implementation-contract.md)：作为 v0.0.1 工程开发主入口，确认 schema、API、权限、事件、标准命令和验收映射。
...
当前优先目标是 v0.0.1 基础可用闭环。实施计划应优先覆盖 [v0.0.1 范围](product/scope-v0.0.1.md) 中的必须实现项，并遵循 [v0.0.1 工程实施合同](implementation/v0.0.1-implementation-contract.md) 和 [技术基线](implementation/technical-baseline.md)。
