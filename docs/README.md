...
4. [技术选型决策](implementation/technical-decision.md)：确认 Go + Vue 技术栈和选型理由。
5. [技术基线](implementation/technical-baseline.md)：确认仓库结构、模块边界、API、数据库、测试和部署约定。
6. [实施文档](implementation/)：查看工程计划、阶段任务和验收记录。
...
当前优先目标是 v0.0.1 基础可用闭环。实施计划应优先覆盖 [v0.0.1 范围](product/scope-v0.0.1.md) 中的必须实现项，并遵循 [技术基线](implementation/technical-baseline.md)。
