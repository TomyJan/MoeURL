...
2. [v0.4.0 范围](product/scope-v0.4.0.md)：确认当前已完成的确认页访问边界。
...
当前已完成到 v0.4.0 确认页访问。涉及确认页、v0.3.0 密码授权或 v0.2.0 中间页、过期时间、二维码、既有 API、schema、权限和验收口径时，应继续参考对应范围、设计与验收文档。
