...
2. [v0.5.0 范围](product/scope-v0.5.0.md)：确认下一版本的内置用户组权限管理边界。
3. [v0.5.0 功能设计](specs/2026-08-20-v0.5.0-user-group-permission-management-design.md)：确认权限目录、预设、保护规则、并发和页面状态。
4. [v0.4.0 范围](product/scope-v0.4.0.md)：回看当前已完成的确认页访问边界。
5. [v0.4.0 功能设计](specs/2026-08-13-v0.4.0-confirmation-page-access-design.md)：回看模式、权限、访问状态机和统计口径。
6. [v0.3.0 范围](product/scope-v0.3.0.md)：回看受保护短链访问的实现边界。
7. [v0.3.0 功能设计](specs/2026-08-04-v0.3.0-protected-link-access-design.md)：回看密码、限流、授权和访问流程设计。
8. [v0.2.0 范围](product/scope-v0.2.0.md)：回看短链访问体验与生命周期的实现边界。
9. [v0.2.0 功能设计](specs/2026-08-02-v0.2.0-link-experience-design.md)：回看中间页、过期时间、二维码和事件设计。
10. [统计与事件](specs/statistics-and-events.md)：确认短链访问事件、基础统计和维度统计口径。
11. [短链](specs/short-links.md)：确认短链访问、状态和事件记录调用点。
12. [跳转模式](specs/redirect-modes.md)：确认直接跳转、中间页和确认页边界。
...
当前已完成到 v0.4.0 确认页访问，v0.5.0 用户组权限管理已完成设计但尚未实施。涉及权限管理、确认页、v0.3.0 密码授权或 v0.2.0 中间页、过期时间、二维码、既有 API、schema、权限和验收口径时，应继续参考对应范围、设计与验收文档。
