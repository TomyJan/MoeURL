...
2. [v0.5.0 范围](product/scope-v0.5.0.md)：确认当前已完成的内置用户组权限管理边界。
3. [v0.5.0 功能设计](specs/2026-08-20-v0.5.0-user-group-permission-management-design.md)：回看权限目录、预设、保护规则、并发和页面状态。
...
当前已完成到 v0.5.0 用户组权限管理。涉及权限管理、确认页、v0.3.0 密码授权或 v0.2.0 中间页、过期时间、二维码、既有 API、schema、权限和验收口径时，应继续参考对应范围、设计与验收文档。
